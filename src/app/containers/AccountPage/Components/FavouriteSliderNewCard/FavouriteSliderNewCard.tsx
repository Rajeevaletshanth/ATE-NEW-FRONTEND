...
export interface FavouriteSliderNewCardProps {
  className?: string;
...
const FavouriteSliderNewCard: FC<FavouriteSliderNewCardProps> = ({
  ...
  const UNIQUE_CLASS =
    "FavouriteSliderNewCard__" + uniqueClassName + useNcId();
  ...
  return (
    <div className={`nc-FavouriteSliderNewCard  ${className}`}>
...
export default FavouriteSliderNewCard;
