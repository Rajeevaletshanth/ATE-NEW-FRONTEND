...
const CardCategory7: FC<CardCategory5Props> = ({
  className = "",
  taxonomy,
}) => {
  ...
  return (
    <Link
      to={href}
      className={`nc-CardCategoryBox1 relative flex items-center p-3 sm:p-0 [ nc-box-has-hover ] [ nc-dark-box-bg-has-hover ]  ${className}`}
